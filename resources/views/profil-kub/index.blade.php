    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content mb-3">
                <div class="text-end">
                    <a href="{{ route('pk.create') }}" class="btn btn-primary btn-sm">Tambah Profil KUB</a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($data as $key => $profil)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('pk.edit', $profil->id) }}">Edit</a>

                                        <button class="btn btn-danger btn-delete" data-id="{{ $profil->id }}"
                                            data-name="{{ $profil->Nama }}" data-url="{{ route('pk.destroy', $profil->id) }}">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
